...
screen main_menu():
    ...
    imagemap:
        ...
        idle "gui/overlay/menu_normal.png"
        hover "gui/overlay/menu_hover.png"

        hotspot(567, 246, 153, 50) action Start()
        hotspot(540, 323, 209, 63) action ShowMenu("load")
        hotspot(532, 398, 222, 76) action ShowMenu("preferences")
        hotspot(566, 494, 145, 53) action ShowMenu("about")
        hotspot(587, 596, 106, 48) action Quit(confirm=True)
        hotspot(1113, 663, 133, 38) action ShowMenu("help")
