...
define gui.about = _p("""
Все персонажи и события являются фанатазиями авторов,
любые сходства являются совпадением

Игра разработана @_latterman

Графическая часть сделана @yana_jkv
""")
...
define config.save_directory = "Tenebris-1635167193"
